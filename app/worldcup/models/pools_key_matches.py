...
class PoolKeyMatch(models.Model):
    team_1 = models.ForeignKey(Team, on_delete=models.CASCADE, related_name='team_1_key_pool', verbose_name='Team 1 pool key')
    team_1_goals = models.IntegerField(default=0, verbose_name='Team 1 goals key')
    team_2 = models.ForeignKey(Team, on_delete=models.CASCADE, related_name='team_2_key_pool', verbose_name='Team 2 pool key')
    ...
    match_number = models.IntegerField(default=0, verbose_name='Pool key match number', unique=True)
